...
timeout /t 1
rem Start "Networking Audio Client2" "..\target\debug\swiftlet.exe" -u Client2 -a [::1]:9001
rem timeout /t 1
rem Start "Networking Audio Client3" "..\target\debug\swiftlet.exe" -u Client3 -a [::1]:9001
